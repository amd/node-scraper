...
class PluginExecutor:
    ...
    def __init__(
        ...
        self.connection_library: dict[type[ConnectionManager], ConnectionManager | None] = {}
        ...
        while len(self.plugin_queue) > 0:
            ...
            if plugin_class.CONNECTION_TYPE:
                ...
                if connection_manager_class not in self.connection_library:
                    ...
                    self.connection_library[connection_manager_class] = connection_manager_class(
